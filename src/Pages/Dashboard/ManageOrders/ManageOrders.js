...
const ManageOrders = () => {
  ...
  useEffect(() => {
    axios
      .get('https://mobiles--store.herokuapp.com/all-orders')
  ...
  const handleStatusChange = (id, status) => {
    ...
    axios
      .put(`https://mobiles--store.herokuapp.com/order/${id}`, modifiedStatus)
      .then((res) => {
        if (res.status === 200) {
  ...
  return (
    <section className='order__manage'>
      <h3>Manage Order</h3>
      <div className='order__manage__orders container'>
